...
public class LoginFrame extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			setUserName(tfuserName.getText().toString()); //metoden setusername sätter den inmatadetexten i variabeln tfusername genom metoden gettext ((metoden to string gör den till en sträng
